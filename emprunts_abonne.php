	...
	<body>
		...
		<?php
			...
			if ($row_cpt == 0) {
				...
				echo '<table><tr><td>Type</td><td>Titre</td><td>Auteur(s)</td><td>Éditeur</td><td>Collection</td><td>Numéro</td><td>Date de publication</td><td>Emprunté le</td><td>À rendre avant le</td><td></td></tr>';
