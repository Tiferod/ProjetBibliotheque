...
<html>
	...
	<body>
		...
		<a href="admin_documents.php">Faire une nouvelle recherche</a></p>
		...
		<p>Nous n'avons trouvé aucun résultat pour votre requête "<?php echo $_POST['requete']; ?>". <a href="admin_documents.php">Réessayez</a> avec autre chose.</p>
		...
		<form action="admin_documents.php" method="Post">
		...
		<form action="document.php" method="post">
			...
			<input name="éditeur" type="text" /></div>
			<div><label>Collection :</label>
			<input name="collection" type="text" /></div>
			<div><label>Numéro :</label>
			<input name="numéro" type="text" /></div>
			<div><label>Date de Publication* :</label>
			<input name="date_publication" type="text" /></div>
